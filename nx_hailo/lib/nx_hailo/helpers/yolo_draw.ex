defmodule NxHailo.Helpers.YOLODraw do
  @font_size 0.5
  @stroke_width 2
  ...
  def draw_tracks(mat, tracks, fps_label) do
    # Note: Evision shape is {h, w, c}
    {full_height, full_width, _channels} = Evision.Mat.shape(mat)
    ...
    mat =
      Enum.reduce(tracks, mat, fn %NxHailo.Trackers.Track{bbox: bbox, id: track_id} = _track,
                                            current_mat ->
        left = bbox.xmin
        top = bbox.ymin
        ...
        bgr_color = class_color(track_id)
